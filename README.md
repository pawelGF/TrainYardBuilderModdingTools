...
Open the Unity Hub. Click “Add” in the “Projects” tab. Select the downloaded Unity project folder. The TrainYardBuilder_CustomBundles project will appear in the Projects list. Click on it and wait for it to load, which may take several minutes the first time.
...
More information can be found in the video : [Train Yard Builder Mods | Configure model materials](https://www.youtube.com/watch?v=YHsZztvjwEc)  

2. Remember about proper model light settings : [Proper light setup](https://www.youtube.com/watch?v=YHsZztvjwEc&t=41s)  
...
[Train Yard Builder Mods | Create a new building with grid to place Decorations](https://youtu.be/VIMInG77UG4)

[Train Yard Builder Mods | Create decorations ](https://youtu.be/9l6hWUa7T6o)

[Train Yard Builder Mods | Create Train ](https://youtu.be/LRmE3Ss427g)

[Train Yard Builder Mods | Create new train cart](https://youtu.be/4dhs-3jnsIM)
...
![](https://github.com/pawelGF/TrainYardBuilderModdingTools/blob/main/Gifs/AddPhoto.png)
